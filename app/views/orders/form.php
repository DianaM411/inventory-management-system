<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<button type="button" class="btn btn-primary" style="border-radius:0%;" onclick="add_tr()">Add Row</button>
		...
		<table class="table table-striped table-hover">
			...
			<tfoot>
				<tr>
					...
					<td ><button type="submit" class="btn btn-success" style="border-radius:0%;">Submit</button></td>
				</tr>
			</tfoot>
		</table>
		<?=form_close() ?>
